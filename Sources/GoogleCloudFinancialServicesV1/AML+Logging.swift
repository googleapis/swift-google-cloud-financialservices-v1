...
extension Clients {
  final class AMLLogging: AMLStub {
    let inner: any AMLStub
    let logger: Logger

    public init(_ inner: any AMLStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-financialservices-v1"
      logger[metadataKey: "gcp.client.service"] = "financialservices"
      logger[metadataKey: "gcp.experimental.swift.client"] = "AML"
      self.inner = inner
      self.logger = logger
    }
